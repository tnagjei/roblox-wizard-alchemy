...
export function createTemplateStrategyPage(slug: StrategySlug, locale = "en"): StrategyPageContent {
  ...
  const completedCopy: Record<string, Pick<StrategyPageContent, "hero" | "summaryCards" | "videos" | "sections" | "relatedLinks" | "faq">> = {
    "updates": {
      hero: {
    ...
    "chest-locations": {
      ...
      summaryCards: [
        { title: "Status", description: "Source-reported and video-assisted. Kept noindex until stronger in-game verification exists." },
        { title: "Route split", description: "Current route draft covers 10 World 1 chest leads and 11 World 2 chest leads." },
        { title: "No copied images", description: "This page does not use Beebom images, YouTube screenshots, or AI-generated fake game screenshots." }
      ],
      videos: {
        ...
        items: [
          { id: "jRwxytBiVcY", title: "Wizard Alchemy chest route video reference 1", note: "Use this as a visual landmark aid while following the written route. Do not treat it as this site's full verification log." },
          { id: "oYwP4rmLdLc", title: "Wizard Alchemy chest route video reference 2", note: "Use this as a secondary reference if the first video does not show the area you need clearly." }
        ]
      },
      sections: [
        {
          ...
          list: ["Route list: source-reported.", "Videos: third-party embedded references.", "Screenshots: not added yet.", "Rewards and respawn timer: pending verification."]
        },
        {
          heading: "Quick route summary",
          body: ["The route draft is split into World 1 and World 2. Start with World 1 if you are new, because the landmarks are easier to read and the route loops around spawn, river, cave, beach, lighthouse, and treehouse areas."],
          list: ["World 1: 10 source-reported chest leads.", "World 2: 11 source-reported chest leads.", "Best use: follow the written route while comparing landmarks in the embedded videos."]
        },
        {
          heading: "World 1 chest route",
          body: ["World 1 should be treated as the learning loop. Move from spawn outward, clear the cave side, then finish through the beach and treehouse route."],
          list: [
        ...
        },
        {
          ...
          body: ["World 2 is more vertical and more dangerous. Expect lava routes, waterfall routes, boss-side checks, and island edges. Movement tools may help, but this page does not claim they are required."],
          list: [
        ...
        },
        {
          ...
          body: ["For a first pass, do not jump randomly between islands. Use one loop per world and write down which spots actually contain a chest in your server."],
          list: ["World 1 order: Spawn back, river, miner cave, secret cave, mountain, goblin campfire, traveller tent, Dwarf King throne, lighthouse, treehouse.", "World 2 order: spawn mountain, enchantment area, small volcano, waterfall arch, Behemoth route, lava stream, magma hat, Mutant Axe Orc island, right-side magma house, waterfall cave, volcano-left beach.", "If a chest is missing, note the server time and return later instead of assuming the route is wrong."]
        },
        {
          heading: "How to open chests",
          body: ["Walk close to a chest and use the in-game interaction prompt when it appears. Keep inventory space available before opening because reward handling is not fully documented by this site yet."],
          list: ["Open chests only inside the Roblox game UI.", "Do not use chest finder scripts or browser tools.", "Do not enter Roblox passwords, cookies, recovery codes, or session tokens anywhere.", "Record any reward result before treating it as verified data."]
        }
      ],
      relatedLinks: [
        { href: localizedHref(locale, "codes"), title: "Codes", description: "Check source-labeled code status before testing race reroll or reward claims." },
        { href: localizedHref(locale, "beginners-guide"), title: "Beginner Guide", description: "Learn the basic game loop before running long chest routes." },
        { href: localizedHref(locale, "updates"), title: "Updates", description: "Watch for map or route changes that could move chest locations." }
      ],
      faq: [
        { q: "Is this Wizard Alchemy chest locations page fully verified?", a: "No. It is a source-reported and video-assisted draft. The page does not claim every spot has been verified by this site." },
        { q: "Why does this page use videos instead of screenshots?", a: "This page avoids copied images and does not yet have original in-game screenshots. Embedded videos provide visual reference while the written route remains clearly marked as source-reported." },
        { q: "How many Wizard Alchemy chest spots are listed here?", a: "The current draft lists 21 source-reported chest leads: 10 in World 1 and 11 in World 2." },
        { q: "How often do chests respawn?", a: "Some third-party sources report fixed respawn timing, but this site has not verified the timer. Treat respawn timing as pending verification." },
        { q: "What rewards do chests give?", a: "This page does not publish exact reward quantities, drop rates, or guaranteed items without in-game proof." }
      ]
    }
  };
